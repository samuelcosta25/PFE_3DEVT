...
const Quiz = () => {
  ...
  return (
    <section style={{...styles.card, backgroundColor: '#e3f2fd', textAlign: 'center'}}>
      ...
      {/* 1. O texto do botão agora é condicional */}
      <button 
        onClick={() => setRespondido(!respondido)} // 2. Inverte o estado (true -> false / false -> true)
        style={styles.button}
      >
        {respondido  ? 'Ocultar Resposta' : 'Ver Resposta'}
      </button>

      {/* 3. A resposta só aparece se 'respondido' for true */}
      {respondido && (
